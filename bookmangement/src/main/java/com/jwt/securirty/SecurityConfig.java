     ...
     SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/user/allbooks").hasRole("USER")
                        .requestMatchers("/user/addbook").hasRole("USER")
                        .requestMatchers("/user/getbook/{isbn}").hasRole("USER")
                        .requestMatchers("/user/updatebook/{isbn}").hasRole("USER")
                        .requestMatchers("/user/deletebook/{isbn}").hasRole("USER")
